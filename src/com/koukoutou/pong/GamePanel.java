...
public class GamePanel extends JPanel implements Runnable {
    ...
    private static final long serialVersionUID = -3172356676639985675L;

    static final int GAME_WIDTH = 1000;
    static final int GAME_HEIGHT = (int) (GAME_WIDTH * (0.5555));
    static final Dimension SCREEN_SIZE = new Dimension(GAME_WIDTH, GAME_HEIGHT);

    static final int BALL_WIDTH = 50;
    ...
    public void newBall() throws IOException {
        random = new Random();
        ball = new Ball((GAME_WIDTH / 2) - (BALL_WIDTH / 2), random.nextInt(GAME_HEIGHT - BALL_HEIGHT), BALL_WIDTH,
                BALL_HEIGHT);
    }

    public void newPaddles() throws IOException {
    ...
    public void checkCollision() throws IOException {
        ...
        if (ball.y >= GAME_HEIGHT - BALL_HEIGHT) {
            ball.setYDirection(-ball.yVelocity);
        }
